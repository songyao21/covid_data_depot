...
**** Please refer to the following document for info about downloading the raw data. 
* https://github.com/songyao21/covid_data_depot/blob/master/Data%20Source%20Description.pdf
**** The code is written in Stata 16

***** Raw data compiled by New York Times (NYT)
***** case and death data at county-date level
insheet using "./case_data/nyt/covid-19-data/us-counties.csv", comma clear
...
save ./county_cases, replace

***** Raw data from NYC Health Department that report cases separately for each borough
import delimited using "./case_data/nyc_data/boro/boroughs-case-hosp-death.csv", clear
...
append using ./build/output/county_cases
drop if fips==99991
* Kansas City
