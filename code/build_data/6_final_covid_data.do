...
use ./county_social_distancing_2_preApr28, clear
...
merge 1:1 fips date using ./county_cases.dta
...
merge m:1 state county using ./county_attributes.dta
keep if _merge == 3
drop _merge
unique fips
...
merge 1:1 fips date using ./raw_data/temp_and_rain.dta
tab _m, m
drop if _merge == 2
drop _merge
...
*merge with humidity
merge 1:1 fips date using ./raw_data/humidity.dta
drop if _merge == 2
drop _merge
...
capture cd "$data"
save ./data_depot/pre_regressions_newdata, replace
