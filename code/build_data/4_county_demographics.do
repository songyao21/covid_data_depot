...
capture cd "$data"
import delimited using ./median_income_tract_2018.csv, clear varnames(1)
...
save ./temp/tract_income, replace

* change to raw data directory
capture cd "$data"
import delimited using ./gender_race_age_tract_2018.csv, clear varnames(1)
* change to processed data directory
capture cd "$repo"
...
merge 1:1 gisjoin using ./temp/tract_income, nogen
drop gisjoin

save ./temp/tract_demo, replace


* aggregate to county level
use ./temp/tract_demo, clear
...
merge 1:1 state county using ./temp/temp, nogen
outsheet using ./county_demo.csv, comma replace
