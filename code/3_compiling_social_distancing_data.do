...
insheet using "./safegraph/social_distancing/2020_v2_1/03/01/2020-03-01-social-distancing.csv", comma clear
...
insheet using "./safegraph/social_distancing/2020_v2_1/03/`date'/2020-03-`date'-social-distancing.csv", comma clear
...
save ./tract_group_social_distancing_032020, replace
...
save ./county_social_distancing_jun16_jun21, replace
